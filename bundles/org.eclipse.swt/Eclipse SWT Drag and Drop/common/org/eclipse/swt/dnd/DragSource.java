...
public class DragSource extends Widget {
	...
	private final NativeDragSource wrappedDragSource;
...
public DragSource(Control control, int style) {
	this.wrappedDragSource = new NativeDragSource(control, style) {
		@Override
...
public void addDragListener(DragSourceListener listener) {
	wrappedDragSource.addDragListener(listener);
}

boolean canBeginDrag() {
	return wrappedDragSource.canBeginDrag();
}
...
public Control getControl() {
	return wrappedDragSource.getControl();
}
...
public DragSourceListener[] getDragListeners() {
	return wrappedDragSource.getDragListeners();
}
...
public DragSourceEffect getDragSourceEffect() {
	return wrappedDragSource.getDragSourceEffect();
}
...
public Transfer[] getTransfer(){
	return wrappedDragSource.getTransfer();
}
...
public void removeDragListener(DragSourceListener listener) {
	wrappedDragSource.removeDragListener(listener);
}
...
public void setDragSourceEffect(DragSourceEffect effect) {
	wrappedDragSource.setDragSourceEffect(effect);
}
...
public void setTransfer(Transfer... transferAgents){
	wrappedDragSource.setTransfer(transferAgents);
}

@Override
protected NativeDragSource getWrappedWidget() {
	return wrappedDragSource;
}
