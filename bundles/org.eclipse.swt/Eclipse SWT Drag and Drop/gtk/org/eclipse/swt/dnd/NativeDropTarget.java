 ...
 * @see DND#DROP_LINK
 */
protected NativeDropTarget(DropTarget wrapper, Control controlWrapper, int style) {
...
static NativeDropTarget FindDropTarget(long handle) {
	...
	return (NativeDropTarget)widget.getData(DND.DROP_TARGET_KEY);
}
...
public void addDropListener(DropTargetListener listener) {
	...
	typedListener.dndWidget = this.wrap();
