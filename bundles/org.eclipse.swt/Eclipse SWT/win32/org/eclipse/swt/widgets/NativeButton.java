 ...
 */
public class NativeButton extends NativeControl implements IButton {
	...
	static {
		...
		DPIZoomChangeRegistry.registerHandler(NativeButton::handleDPIChange, Button.class);
	}
...
void selectRadio () {
	for (NativeControl child : parent._getChildren ()) {
...
private static void handleDPIChange(Widget widget, int newZoom, float scalingFactor) {
	if (!(Widget.checkNative(widget) instanceof NativeButton button)) {
		return;
	}
