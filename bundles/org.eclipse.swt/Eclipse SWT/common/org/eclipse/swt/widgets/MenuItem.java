...
public class MenuItem extends Item {
	...
	private final NativeMenuItem wrappedMenuItem;
...
public void addArmListener (ArmListener listener) {
	wrappedMenuItem.addArmListener(listener);
}
...
public void addHelpListener (HelpListener listener) {
	wrappedMenuItem.addHelpListener(listener);
}
...
public void addSelectionListener (SelectionListener listener) {
	wrappedMenuItem.addSelectionListener(listener);
}
...
public int getAccelerator () {
	return wrappedMenuItem.getAccelerator();
}
...
public boolean getEnabled () {
	return wrappedMenuItem.getEnabled();
}
...
public Menu getParent () {
	NativeMenu wrappedMenu = wrappedMenuItem.getParent();
	return wrappedMenu != null ? wrappedMenu.wrap() : null;
}
...
public boolean getSelection () {
	return wrappedMenuItem.getSelection();
}
...
public String getToolTipText () {
	return wrappedMenuItem.getToolTipText();
}
...
public void removeArmListener (ArmListener listener) {
	wrappedMenuItem.removeArmListener(listener);
}
/**
 * Removes the listener from the collection of listeners who will
...
public void removeHelpListener (HelpListener listener) {
	wrappedMenuItem.removeHelpListener(listener);
}
/**
 * Removes the listener from the collection of listeners who will
...
public void removeSelectionListener (SelectionListener listener) {
	wrappedMenuItem.removeSelectionListener(listener);
}
...
public void setAccelerator (int accelerator) {
	wrappedMenuItem.setAccelerator(accelerator);
}
...
public void setEnabled (boolean enabled) {
	wrappedMenuItem.setEnabled(enabled);
}
...
public void setImage (Image image) {
	wrappedMenuItem.setImage(image);
}
...
public void setMenu (Menu menu) {
	wrappedMenuItem.setMenu(checkNative(menu));
}
...
public void setSelection (boolean selected) {
	wrappedMenuItem.setSelection(selected);
}
/**
...
public void setText (String string) {
	wrappedMenuItem.setText(string);
}
...
public void setToolTipText (String toolTip) {
	wrappedMenuItem.setToolTipText(toolTip);
}

@Override
protected NativeMenuItem getWrappedWidget() {
