...
public Rectangle computeTrim (int x, int y, int width, int height) {
	return getWrappedWidget().computeTrim(x, y, width, height);
}
...
public Rectangle getClientArea () {
	return getWrappedWidget().getClientArea();
}
...
public ScrollBar getHorizontalBar () {
	...
	return wrappedHorizontalBar != null ? wrappedHorizontalBar.wrap() : null;
}
...
public int getScrollbarsMode () {
	return getWrappedWidget().getScrollbarsMode();
}
...
public void setScrollbarsMode (int mode) {
	getWrappedWidget().setScrollbarsMode(mode);
}
...
public ScrollBar getVerticalBar () {
	...
	return wrappedVerticalBar != null ? wrappedVerticalBar.wrap() : null;
}
