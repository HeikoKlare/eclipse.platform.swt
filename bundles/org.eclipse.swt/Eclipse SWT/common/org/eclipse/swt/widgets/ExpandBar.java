...
public class ExpandBar extends Composite {
	...
	private final NativeExpandBar wrappedExpandBar;
...
public void addExpandListener (ExpandListener listener) {
	wrappedExpandBar.addExpandListener(listener);
}
...
public ExpandItem getItem (int index) {
	...
	return wrappedExpandItem != null ? wrappedExpandItem.wrap() : null;
}
...
public int getItemCount () {
	return wrappedExpandBar.getItemCount();
}
...
public ExpandItem [] getItems () {
	return Arrays.stream(wrappedExpandBar.getItems()).map(NativeExpandItem::wrap).toArray(ExpandItem[]::new);
}
...
public int getSpacing () {
	return wrappedExpandBar.getSpacing();
}
...
public void removeExpandListener (ExpandListener listener) {
	wrappedExpandBar.removeExpandListener(listener);
}
...
public void setSpacing (int spacing) {
	wrappedExpandBar.setSpacing(spacing);
}

@Override
protected NativeExpandBar getWrappedWidget() {
	return wrappedExpandBar;
}
