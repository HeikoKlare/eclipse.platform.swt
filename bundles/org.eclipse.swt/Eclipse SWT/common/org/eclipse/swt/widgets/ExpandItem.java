...
public class ExpandItem extends Item {
	...
	private final NativeExpandItem wrappedExpandItem;
...
public boolean getExpanded () {
	return wrappedExpandItem.getExpanded();
}
...
public int getHeaderHeight () {
	return wrappedExpandItem.getHeaderHeight();
}
...
public int getHeight () {
	return wrappedExpandItem.getHeight();
}
...
public ExpandBar getParent () {
	NativeExpandBar wrappedParent = wrappedExpandItem.getParent();
...
public void setControl (Control control) {
	wrappedExpandItem.setControl(checkNative(control));
}
...
public void setExpanded (boolean expanded) {
	wrappedExpandItem.setExpanded(expanded);
}
...
public void setHeight (int height) {
	wrappedExpandItem.setHeight(height);
}

@Override
protected NativeExpandItem getWrappedWidget() {
	return wrappedExpandItem;
}
