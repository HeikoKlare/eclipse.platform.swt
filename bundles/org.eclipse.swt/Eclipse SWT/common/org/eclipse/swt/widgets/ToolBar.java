...
public ToolItem getItem (int index) {
	...
	return wrappedToolItem != null ? wrappedToolItem.wrap() : null;
}
...
public int getItemCount () {
	return wrappedToolBar.getItemCount();
}
...
public ToolItem [] getItems () {
	return Arrays.stream(wrappedToolBar.getItems()).map(NativeToolItem::wrap).toArray(ToolItem[]::new);
}
...
public int getRowCount () {
	return wrappedToolBar.getRowCount();
}
