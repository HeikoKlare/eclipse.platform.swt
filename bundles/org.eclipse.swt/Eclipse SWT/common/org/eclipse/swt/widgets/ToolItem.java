...
public void addSelectionListener(SelectionListener listener) {
	wrappedToolItem.addSelectionListener(listener);
}
...
public Rectangle getBounds () {
	return wrappedToolItem.getBounds();
}
...
public Image getDisabledImage () {
	return wrappedToolItem.getDisabledImage();
}
...
public Color getBackground () {
	return wrappedToolItem.getBackground();
}
...
public boolean getEnabled () {
	return wrappedToolItem.getEnabled();
}
...
public Color getForeground () {
	return wrappedToolItem.getForeground();
}
...
public Image getHotImage () {
	return wrappedToolItem.getHotImage();
}
...
public Image getImage () {
	return wrappedToolItem.getImage();
}
...
public ToolBar getParent () {
	...
	return wrappedToolBar != null ? wrappedToolBar.wrap() : null;
}
...
public boolean getSelection () {
	return wrappedToolItem.getSelection();
}
...
public String getToolTipText () {
	return wrappedToolItem.getToolTipText();
}
 ...
 */
public int getWidth () {
	return wrappedToolItem.getWidth();
}
...
public boolean isEnabled () {
	return wrappedToolItem.isEnabled();
}
...
public void removeSelectionListener(SelectionListener listener) {
	wrappedToolItem.removeSelectionListener(listener);
}
...
public void setBackground (Color color) {
	wrappedToolItem.setBackground(color);
}
...
public void setEnabled (boolean enabled) {
	wrappedToolItem.setEnabled(enabled);
}
...
public void setDisabledImage (Image image) {
	wrappedToolItem.setDisabledImage(image);
}
...
public void setForeground (Color color) {
	wrappedToolItem.setForeground(color);
}
...
public void setHotImage (Image image) {
	wrappedToolItem.setHotImage(image);
}

@Override
public void setImage (Image image) {
	wrappedToolItem.setImage(image);
}
...
public void setSelection (boolean selected) {
	wrappedToolItem.setSelection(selected);
}
...
public void setText (String string) {
	wrappedToolItem.setText(string);
}
...
public void setToolTipText (String string) {
	wrappedToolItem.setToolTipText(string);
}
...
public void setWidth (int width) {
	wrappedToolItem.setWidth(width);
}
