...
public void addSelectionListener (SelectionListener listener) {
	wrappedToolTip.addSelectionListener(listener);
}
...
public boolean getAutoHide () {
	return wrappedToolTip.getAutoHide();
}
...
public String getMessage () {
	return wrappedToolTip.getMessage();
}
...
public Shell getParent () {
	NativeShell wrappedShell = wrappedToolTip.getParent();
...
public boolean getVisible () {
	return wrappedToolTip.getVisible();
}
...
public boolean isVisible () {
	return wrappedToolTip.isVisible();
}
...
public void removeSelectionListener (SelectionListener listener) {
	wrappedToolTip.removeSelectionListener(listener);
}
...
public void setAutoHide (boolean autoHide) {
	wrappedToolTip.setAutoHide(autoHide);
}
...
public void setLocation (int x, int y) {
	wrappedToolTip.setLocation(x, y);
}
...
public void setLocation (Point location) {
	wrappedToolTip.setLocation(location);
}
...
public void setMessage (String string) {
	wrappedToolTip.setMessage(string);
}
...
public void setVisible (boolean visible) {
	wrappedToolTip.setVisible(visible);
}

@Override
protected NativeToolTip getWrappedWidget() {
