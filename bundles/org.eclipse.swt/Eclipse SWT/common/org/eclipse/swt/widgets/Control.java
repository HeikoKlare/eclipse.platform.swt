...
public void addControlListener(ControlListener listener) {
	getWrappedWidget().addControlListener(listener);
}
...
public void addDragDetectListener (DragDetectListener listener) {
	getWrappedWidget().addDragDetectListener(listener);
}
...
public void addFocusListener (FocusListener listener) {
	getWrappedWidget().addFocusListener(listener);
}
...
public void addGestureListener (GestureListener listener) {
	getWrappedWidget().addGestureListener(listener);
}
...
public void addHelpListener (HelpListener listener) {
	getWrappedWidget().addHelpListener(listener);
}
...
public void addKeyListener (KeyListener listener) {
	getWrappedWidget().addKeyListener(listener);
}
...
public void addMenuDetectListener (MenuDetectListener listener) {
	getWrappedWidget().addMenuDetectListener(listener);
}
...
public void addMouseListener (MouseListener listener) {
	getWrappedWidget().addMouseListener(listener);
}
...
public void addMouseTrackListener (MouseTrackListener listener) {
	getWrappedWidget().addMouseTrackListener(listener);
}
...
public void addMouseMoveListener (MouseMoveListener listener) {
	getWrappedWidget().addMouseMoveListener(listener);
}
...
public void addMouseWheelListener (MouseWheelListener listener) {
	getWrappedWidget().addMouseWheelListener(listener);
}
...
public void addPaintListener (PaintListener listener) {
	getWrappedWidget().addPaintListener(listener);
}
...
public void addTouchListener (TouchListener listener) {
	getWrappedWidget().addTouchListener(listener);
}
...
public void addTraverseListener (TraverseListener listener) {
	getWrappedWidget().addTraverseListener(listener);
}
...
public Point computeSize (int wHint, int hHint) {
	return getWrappedWidget().computeSize(wHint, hHint);
}
...
public Point computeSize (int wHint, int hHint, boolean changed){
	return getWrappedWidget().computeSize(wHint, hHint, changed);
}
...
public boolean dragDetect (Event event) {
	return getWrappedWidget().dragDetect(event);
}
...
public boolean forceFocus () {
	return getWrappedWidget().forceFocus();
}
...
public Accessible getAccessible () {
	return getWrappedWidget().getAccessible();
}
...
public Color getBackground () {
	return getWrappedWidget().getBackground();
}
...
public Image getBackgroundImage () {
	return getWrappedWidget().getBackgroundImage();
}
...
public int getBorderWidth () {
	return getWrappedWidget().getBorderWidth();
}
...
public Rectangle getBounds (){
	return getWrappedWidget().getBounds();
}
...
public Cursor getCursor () {
	return getWrappedWidget().getCursor();
}
...
public boolean getDragDetect () {
	return getWrappedWidget().getDragDetect();
}
...
public boolean getEnabled () {
	return getWrappedWidget().getEnabled();
}
 ...
 */
public Font getFont () {
	return getWrappedWidget().getFont();
}
...
public Color getForeground () {
	return getWrappedWidget().getForeground();
}
...
public Object getLayoutData () {
	return getWrappedWidget().getLayoutData();
}
...
public Point getLocation () {
	return getWrappedWidget().getLocation();
}
...
public Monitor getMonitor () {
	return getWrappedWidget().getMonitor();
}
...
public int getOrientation () {
	return getWrappedWidget().getOrientation();
}
...
public Region getRegion () {
	return getWrappedWidget().getRegion();
}
...
public Point getSize (){
	return getWrappedWidget().getSize();
}
...
public int getTextDirection() {
	return getWrappedWidget().getTextDirection();
}
...
public String getToolTipText () {
	return getWrappedWidget().getToolTipText();
}
...
public boolean getTouchEnabled () {
	return getWrappedWidget().getTouchEnabled();
}
...
public boolean getVisible () {
	return getWrappedWidget().getVisible();
}
...
public long internal_new_GC (GCData data) {
	return getWrappedWidget().internal_new_GC(data);
}
...
public void internal_dispose_GC (long hDC, GCData data) {
	getWrappedWidget().internal_dispose_GC(hDC, data);
}
...
public boolean isEnabled () {
	return getWrappedWidget().isEnabled();
}
...
public boolean isFocusControl () {
	return getWrappedWidget().isFocusControl();
}
...
public boolean isVisible () {
	return getWrappedWidget().isVisible();
}
...
public boolean print (GC gc) {
	return getWrappedWidget().print(gc);
}
...
public void requestLayout () {
	getWrappedWidget().requestLayout();
}
...
public void redraw (int x, int y, int width, int height, boolean all) {
	getWrappedWidget().redraw(x, y, width, height, all);
}
...
public void removeControlListener (ControlListener listener) {
	getWrappedWidget().removeControlListener(listener);
}
...
public void removeDragDetectListener(DragDetectListener listener) {
	getWrappedWidget().removeDragDetectListener(listener);
}
...
public void removeFocusListener(FocusListener listener) {
	getWrappedWidget().removeFocusListener(listener);
}
...
public void removeGestureListener (GestureListener listener) {
	getWrappedWidget().removeGestureListener(listener);
}
...
public void removeHelpListener (HelpListener listener) {
	getWrappedWidget().removeHelpListener(listener);
}
...
public void removeKeyListener(KeyListener listener) {
	getWrappedWidget().removeKeyListener(listener);
}
...
public void removeMenuDetectListener (MenuDetectListener listener) {
	getWrappedWidget().removeMenuDetectListener(listener);
}
...
public void removeMouseTrackListener(MouseTrackListener listener) {
	getWrappedWidget().removeMouseTrackListener(listener);
}
...
public void removeMouseListener (MouseListener listener) {
	getWrappedWidget().removeMouseListener(listener);
}
...
public void removeMouseMoveListener(MouseMoveListener listener) {
	getWrappedWidget().removeMouseMoveListener(listener);
}
...
public void removeMouseWheelListener (MouseWheelListener listener) {
	getWrappedWidget().removeMouseWheelListener(listener);
}
...
public void removePaintListener(PaintListener listener) {
	getWrappedWidget().removePaintListener(listener);
}
...
public void removeTouchListener(TouchListener listener) {
	getWrappedWidget().removeTouchListener(listener);
}
...
public void removeTraverseListener(TraverseListener listener) {
	getWrappedWidget().removeTraverseListener(listener);
}
...
public void setBackground (Color color) {
	getWrappedWidget().setBackground(color);
}
...
public void setBackgroundImage (Image image) {
	getWrappedWidget().setBackgroundImage(image);
}
...
public void setBounds(int x, int y, int width, int height) {
	getWrappedWidget().setBounds(x, y, width, height);
}
...
public void setBounds (Rectangle rect) {
	getWrappedWidget().setBounds(rect);
}
...
public void setCapture (boolean capture) {
	getWrappedWidget().setCapture(capture);
}
...
public void setCursor (Cursor cursor) {
	getWrappedWidget().setCursor(cursor);
}
...
public void setDragDetect (boolean dragDetect) {
	getWrappedWidget().setDragDetect(dragDetect);
}
...
public void setEnabled (boolean enabled) {
	getWrappedWidget().setEnabled(enabled);
}
...
public boolean setFocus () {
	return getWrappedWidget().setFocus();
}
...
public void setForeground (Color color) {
	getWrappedWidget().setForeground(color);
}
...
public void setLayoutData (Object layoutData) {
	getWrappedWidget().setLayoutData(layoutData);
}
...
public void setLocation (int x, int y) {
	getWrappedWidget().setLocation(x, y);
}
...
public void setLocation (Point location) {
	getWrappedWidget().setLocation(location);
}
...
public void setRedraw (boolean redraw) {
	getWrappedWidget().setRedraw(redraw);
}
...
public void setRegion (Region region) {
	getWrappedWidget().setRegion(region);
}
...
public void setSize (int width, int height) {
	getWrappedWidget().setSize(width, height);
}
...
public void setTextDirection(int textDirection) {
	getWrappedWidget().setTextDirection(textDirection);
}
...
public void setToolTipText (String string) {
	getWrappedWidget().setToolTipText(string);
}
...
public void setTouchEnabled(boolean enabled) {
	getWrappedWidget().setTouchEnabled(enabled);
}
...
public void setVisible (boolean visible) {
	getWrappedWidget().setVisible(visible);
}
...
public Point toControl (int x, int y) {
	return getWrappedWidget().toControl(x, y);
}
...
public Point toControl (Point point) {
	return getWrappedWidget().toControl(point);
}
...
public Point toDisplay (int x, int y) {
	return getWrappedWidget().toDisplay(x, y);
}
...
public Point toDisplay (Point point) {
	return getWrappedWidget().toDisplay(point);
}
...
public boolean traverse (int traversal) {
	return getWrappedWidget().traverse(traversal);
}
...
public boolean traverse (int traversal, Event event) {
	return getWrappedWidget().traverse(traversal, event);
}
