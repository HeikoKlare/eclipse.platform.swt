...
public void addSelectionListener (SelectionListener listener) {
	wrappedSlider.addSelectionListener(listener);
}
...
public int getIncrement () {
	return wrappedSlider.getIncrement();
}
...
public int getMaximum () {
	return wrappedSlider.getMaximum();
}
...
public int getMinimum () {
	return wrappedSlider.getMinimum();
}
...
public int getPageIncrement () {
	return wrappedSlider.getPageIncrement();
}
...
public int getSelection () {
	return wrappedSlider.getSelection();
}
...
public void removeSelectionListener (SelectionListener listener) {
	wrappedSlider.removeSelectionListener(listener);
}
...
public void setIncrement (int value) {
	wrappedSlider.setIncrement(value);
}
...
public void setMaximum (int value) {
	wrappedSlider.setMaximum(value);
}
...
public void setMinimum (int value) {
	wrappedSlider.setMinimum(value);
}
...
public void setPageIncrement (int value) {
	wrappedSlider.setPageIncrement(value);
}
...
public void setSelection (int value) {
	wrappedSlider.setSelection(value);
}
...
public void setValues (int selection, int minimum, int maximum, int thumb, int increment, int pageIncrement) {
	wrappedSlider.setValues(selection, minimum, maximum, thumb, increment, pageIncrement);
}
