...
public class IME extends Widget {
	private final NativeIME wrappedIME;
...
public int getCaretOffset () {
	return wrappedIME.getCaretOffset();
}
...
public int getCommitCount () {
	return wrappedIME.getCommitCount();
}
...
public int getCompositionOffset () {
	return wrappedIME.getCompositionOffset();
}
...
public boolean getWideCaret() {
	return wrappedIME.getWideCaret();
}
...
public void setCompositionOffset (int offset) {
	wrappedIME.setCompositionOffset(offset);
}

@Override
protected NativeIME getWrappedWidget() {
	return wrappedIME;
}
