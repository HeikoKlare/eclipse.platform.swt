...
public class Menu extends Widget {
	...
	private final NativeMenu wrappedMenu;
...
public void addHelpListener (HelpListener listener) {
	wrappedMenu.addHelpListener(listener);
}
...
public void addMenuListener (MenuListener listener) {
	wrappedMenu.addMenuListener(listener);
}
...
public MenuItem getDefaultItem () {
	NativeMenuItem wrappedMenuItem = wrappedMenu.getDefaultItem();
	return wrappedMenuItem != null ? wrappedMenuItem.wrap() : null;
}
...
public MenuItem getItem (int index) {
	NativeMenuItem wrappedMenuItem = wrappedMenu.getItem(index);
	return wrappedMenuItem != null ? wrappedMenuItem.wrap() : null;
}
...
public int getItemCount () {
	return wrappedMenu.getItemCount();
}
...
public MenuItem [] getItems () {
	return Arrays.stream(wrappedMenu.getItems()).map(NativeMenuItem::wrap).toArray(MenuItem[]::new);
}
...
public int getOrientation () {
	return wrappedMenu.getOrientation();
}
...
public MenuItem getParentItem () {
	NativeMenuItem wrappedParentItem = wrappedMenu.getParentItem();
	return wrappedParentItem != null ? wrappedParentItem.wrap() : null;
}
...
public Menu getParentMenu () {
	NativeMenu wrappedParentMenu = wrappedMenu.getParentMenu();
	return wrappedParentMenu != null ? wrappedParentMenu.wrap() : null;
}
...
public Shell getShell () {
	NativeShell wrappedShell = wrappedMenu.getShell();
...
public int indexOf (MenuItem item) {
	return wrappedMenu.indexOf(checkNative(item));
}
...
public void removeHelpListener (HelpListener listener) {
	wrappedMenu.removeHelpListener(listener);
}
...
public void removeMenuListener (MenuListener listener) {
	wrappedMenu.removeMenuListener(listener);
}
...
public void setDefaultItem (MenuItem item) {
	wrappedMenu.setDefaultItem(checkNative(item));
}
...
public void setEnabled (boolean enabled) {
	wrappedMenu.setEnabled(enabled);
}
...
public void setLocation (Point location) {
	wrappedMenu.setLocation(location);
}
...
public void setOrientation (int orientation) {
	wrappedMenu.setOrientation(orientation);
}
...
public void setVisible (boolean visible) {
	wrappedMenu.setVisible(visible);
}

@Override
protected NativeMenu getWrappedWidget() {
	return wrappedMenu;
}
