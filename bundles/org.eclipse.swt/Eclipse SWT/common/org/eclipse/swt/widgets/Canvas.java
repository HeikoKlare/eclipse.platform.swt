...
public void drawBackground (GC gc, int x, int y, int width, int height) {
	wrappedCanvas.drawBackground(gc, x, y, width, height);
}
...
public Caret getCaret () {
	...
	return wrappedCaret != null ? wrappedCaret.wrap() : null;
}
...
public IME getIME () {
	...
	return wrappedIME != null ? wrappedIME.wrap() : null;
}
...
public void scroll (int destX, int destY, int x, int y, int width, int height, boolean all) {
	wrappedCanvas.scroll(destX, destY, x, y, width, height, all);
}
