...
public void drawBackground (GC gc, int x, int y, int width, int height, int offsetX, int offsetY) {
	getWrappedWidget().drawBackground(gc, x, y, width, height, offsetX, offsetY);
}
...
public int getBackgroundMode () {
	return getWrappedWidget().getBackgroundMode();
}
...
public Control [] getChildren () {
	return Arrays.stream(getWrappedWidget().getChildren()).map(NativeControl::wrap).toArray(Control[]::new);
}
...
public Layout getLayout () {
	return getWrappedWidget().getLayout();
}
...
public Control [] getTabList () {
	return Arrays.stream(getWrappedWidget().getTabList()).map(NativeControl::wrap).toArray(Control[]::new);
}
...
public boolean getLayoutDeferred () {
	return getWrappedWidget().getLayoutDeferred();
}
...
public boolean isLayoutDeferred () {
	return getWrappedWidget().isLayoutDeferred();
}
...
public void layout (boolean changed, boolean all) {
	getWrappedWidget().layout(changed, all);
}
...
public void setBackgroundMode (int mode) {
	getWrappedWidget().setBackgroundMode(mode);
}
...
public void setLayout (Layout layout) {
	getWrappedWidget().setLayout(layout);
}
...
public void setLayoutDeferred (boolean defer) {
	getWrappedWidget().setLayoutDeferred(defer);
}
/**
