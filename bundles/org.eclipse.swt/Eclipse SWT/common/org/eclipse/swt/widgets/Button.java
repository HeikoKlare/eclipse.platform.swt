...
public Button (Composite parent, int style) {
	this.wrappedButton = new NativeButton(this, checkNative(parent), style);
}
...
public void addSelectionListener (SelectionListener listener) {
	wrappedButton.addSelectionListener(listener);
}
...
public int getAlignment () {
	return wrappedButton.getAlignment();
}
...
public boolean getGrayed () {
	return wrappedButton.getGrayed();
}
...
public boolean getSelection () {
	return wrappedButton.getSelection();
}
...
public void removeSelectionListener (SelectionListener listener) {
	wrappedButton.removeSelectionListener(listener);
}
...
public void setAlignment (int alignment) {
	wrappedButton.setAlignment(alignment);
}
...
public void setBackground (Color color) {
	wrappedButton.setBackground(color);
}
...
public void setGrayed (boolean grayed) {
	wrappedButton.setGrayed(grayed);
}
...
public void setSelection (boolean selected) {
	wrappedButton.setSelection(selected);
}
