...
public int getMaximum () {
	return wrappedProgressBar.getMaximum();
}
...
public int getMinimum () {
	return wrappedProgressBar.getMinimum();
}
...
public int getSelection () {
	return wrappedProgressBar.getSelection();
}
 ...
 */
public int getState () {
	return wrappedProgressBar.getState();
}
...
public void setMaximum (int value) {
	wrappedProgressBar.setMaximum(value);
}
...
public void setMinimum (int value) {
	wrappedProgressBar.setMinimum(value);
}
...
public void setSelection (int value) {
	wrappedProgressBar.setSelection(value);
}
...
public void setState (int state) {
	wrappedProgressBar.setState(state);
}
