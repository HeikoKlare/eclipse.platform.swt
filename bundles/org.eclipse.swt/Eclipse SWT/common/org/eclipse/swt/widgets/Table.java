...
public TableColumn getColumn (int index) {
	...
	return wrappedTableColumn != null ? wrappedTableColumn.wrap() : null;
}
...
public TableColumn [] getColumns () {
	return Arrays.stream(wrappedTable.getColumns()).map(NativeTableColumn::wrap).toArray(TableColumn[]::new);
}
...
public TableItem getItem (int index) {
	...
	return wrappedTableItem != null ? wrappedTableItem.wrap() : null;
}
...
public TableItem [] getItems () {
	return Arrays.stream(wrappedTable.getItems()).map(NativeTableItem::wrap).toArray(TableItem[]::new);
}
...
public TableItem [] getSelection () {
	return Arrays.stream(wrappedTable.getSelection()).map(NativeTableItem::wrap).toArray(TableItem[]::new);
}
