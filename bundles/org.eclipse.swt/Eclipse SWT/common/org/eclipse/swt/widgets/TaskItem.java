...
public class TaskItem extends Item {
	...
	private final NativeTaskItem wrappedTaskItem;
...
public Image getOverlayImage () {
	return wrappedTaskItem.getOverlayImage();
}
...
public String getOverlayText () {
	return wrappedTaskItem.getOverlayText();
}
...
public TaskBar getParent () {
	NativeTaskBar wrappedTaskBar = wrappedTaskItem.getParent();
	return wrappedTaskBar != null ? wrappedTaskBar.wrap() : null;
}
...
public int getProgress () {
	return wrappedTaskItem.getProgress();
}
...
public int getProgressState () {
	return wrappedTaskItem.getProgressState();
}
...
public void setMenu (Menu menu) {
	wrappedTaskItem.setMenu(checkNative(menu));
}
...
public void setOverlayImage (Image overlayImage) {
	wrappedTaskItem.setOverlayImage(overlayImage);
}
...
public void setOverlayText (String overlayText) {
	wrappedTaskItem.setOverlayText(overlayText);
}
...
public void setProgress (int progress) {
	wrappedTaskItem.setProgress(progress);
}
...
public void setProgressState (int progressState) {
	wrappedTaskItem.setProgressState(progressState);
}

@Override
protected NativeTaskItem getWrappedWidget() {
	return wrappedTaskItem;
}
