 ...
 */
public class NativeOleClientSite extends NativeComposite {
	OleClientSite wrapperOleClientSite;
	...
	protected NativeOleFrame frame;
...
protected NativeOleClientSite(NativeComposite parent, int style) {
	/*
	...
	while (parent != null) {
		if (parent instanceof NativeOleFrame){
 ...
 * </ul>
 */
public NativeOleClientSite(NativeComposite parent, int style, File file) {
	this(parent, style);
	try {
 ...
 * </ul>
 */
public NativeOleClientSite(NativeComposite parent, int style, String progId) {
	this(parent, style);
	try {
 ...
 */
public NativeOleClientSite(NativeComposite parent, int style, String progId, File file) {
	this(parent, style);
	try {
...
@Override
protected OleClientSite wrap() {
	return wrapperOleClientSite;
}
