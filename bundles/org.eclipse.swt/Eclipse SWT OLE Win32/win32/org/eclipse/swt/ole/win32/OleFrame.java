...
public OleFrame(Composite parent, int style) {
	...
	this.wrappedOleFrame.wrapperOleFrame = this;
}
...
public MenuItem[] getContainerMenus(){
	return Arrays.stream(wrappedOleFrame.getContainerMenus()).map(NativeMenuItem::wrap).toArray(MenuItem[]::new);
}
/**
 *
...
public MenuItem[] getFileMenus(){
	return Arrays.stream(wrappedOleFrame.getFileMenus()).map(NativeMenuItem::wrap).toArray(MenuItem[]::new);
}
/**
 *
...
public MenuItem[] getWindowMenus(){
	return Arrays.stream(wrappedOleFrame.getWindowMenus()).map(NativeMenuItem::wrap).toArray(MenuItem[]::new);
}
/**
 *
