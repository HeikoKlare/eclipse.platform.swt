 ...
 */
public class NativeOleControlSite extends NativeOleClientSite
{
	OleControlSite wrappedOleControlSite;
 ...
 * @since 3.5
 */
public NativeOleControlSite(NativeComposite parent, int style, File file) {
 ...
 * </ul>
 */
public NativeOleControlSite(NativeComposite parent, int style, String progId) {
	super(parent, style);
	try {
 ...
 * @since 3.5
 */
public NativeOleControlSite(NativeComposite parent, int style, String progId, File file) {
...
public Color getBackground () {
	...
	if (objIUnknown != null) {
		...
		OleAutomation oleObject= new OleAutomation(this.wrap());
...
@Override
protected OleControlSite wrap() {
	return wrappedOleControlSite;
}
